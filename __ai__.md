...
## Last Verified (CI)
- commit: e7c0f3f42f279de7fb456f59fc5ddce80d7b41f9
- timestamp_utc: 2026-04-18T21:06:28Z
- verified_by: ci
...
- The current MVP-supported package surface is now centered on `context_atlas.api`; repo-level docs should prefer that curated starter namespace over deep internal module paths unless they are deliberately teaching architectural seams.
