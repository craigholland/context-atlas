...
- The portable agentic layer should preserve an explicit three-layer split between portable canon, Context Atlas-specific bindings, and runtime-specific materialization; contributors should not let project roles or vendor folder conventions leak upward into the canon.
