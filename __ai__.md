...
- The current active MVP task is Story 7 Task 7.1, which is adding a budget-constrained proof scenario so the MVP evidence shows visible tradeoffs under real pressure.
