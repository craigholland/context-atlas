...
- Story 3 Task 3.3 now also carries a boundary-reinforcement rule: Canon entry surfaces may point readers to the current repository's Identity landing docs, and those downstream Identity entry surfaces should preserve a clear descent path from structural profile to current runtime binding rather than acting like disconnected local notes.
