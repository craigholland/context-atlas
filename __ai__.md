...
- The materialization manifest should keep parent direct skills, parent conditional skills, delegated specialists, and specialist-attached skills together in one machine-readable attachment map while preserving those semantics as distinct concepts rather than flattening them into one generic list.
