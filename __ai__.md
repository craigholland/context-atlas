...
- Hardening Task 5.3 should keep `docs/Release/README.md` honest about shipped history versus current development-branch guidance; release-history docs should not imply that an unreleased hardening closeout is already part of `0.1.1` or any other shipped tag.
