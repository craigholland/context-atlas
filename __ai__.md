...
- The current active MVP task is Story 5 Task 5.1, which is defining the low-code workflow shape around the shared Atlas engine and configuration surface; repo-level guidance should stay aligned with that task until its feature PR is reviewed and merged.
