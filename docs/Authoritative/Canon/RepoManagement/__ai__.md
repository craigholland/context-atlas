...
steps:
  - name: validate_owner_file
    run: |
      python scripts/validate_ai_docs.py --repo-root . --files docs/Authoritative/Canon/RepoManagement/__ai__.md __ai__.md

  - name: validate_related_owner_files
    run: |
      python scripts/validate_ai_docs.py --repo-root . --files docs/Authoritative/Canon/RepoManagement/__ai__.md docs/Authoritative/Canon/AgenticDevelopment/__ai__.md __ai__.md
